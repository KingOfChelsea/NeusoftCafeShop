<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper circular @change="NeusoftOnchange">
          <swiper-item v-for="item in goods?.mainPictures" :key="item">
            <image mode="aspectFill" :src="item" @tap="NeusoftOnTapImage(item)" />
          </swiper-item>
        </swiper>
...
import { getGoodsByIdAPI } from '@/services/NeusoftGoods'
...
//2.4 轮播图图片放大预览
const NeusoftOnTapImage = (url: string) => {
  uni.previewImage({
    current: url,
